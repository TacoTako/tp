...
public class HelpCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Displays help information and usage details "
            + "for commands.\n"
            + "Usage:\n"
            + "  " + COMMAND_WORD + " — Shows a summary of all commands\n"
            + "  " + COMMAND_WORD + " COMMAND_WORD — Shows help for the specified command\n"
            + "  " + COMMAND_WORD + " " + LINK_FLAG + " — Opens a help window with user guide link\n"
            + "Examples:\n"
            + "  " + COMMAND_WORD + "\n"
            + "  " + COMMAND_WORD + " add\n"
